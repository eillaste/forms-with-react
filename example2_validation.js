//src=https://blog.stvmlbrn.com/2017/01/16/form-validation-with-react.html
...
class SignUp extends Component {
	...
	// this.setState({	...this.state, [e.target.name]: { ...this.state[e.target.name], value: e.target.value }});
